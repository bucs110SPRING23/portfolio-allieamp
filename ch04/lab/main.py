...
screen.fill("black")
hitboxes = {
    "Player1": pygame.Rect(0,100,hitbox_width/2,hitbox_height/2),
    "Player2": pygame.Rect(50+hitbox_width/2,100,hitbox_width/2,hitbox_height/2),
}
box_colors = {
    "Player1":(0,100,0),
    "Player2":(100,0,100),
...
screen.fill("black")
pygame.display.flip()
pygame.draw.circle(screen,"white",(hitbox_width,hitbox_height),hitbox_height+5)  
pygame.draw.circle(screen,"blue",(hitbox_width,hitbox_height),hitbox_height)
...
pygame.draw.circle(screen,"blue",(hitbox_width,hitbox_height),hitbox_height-300)                        
pygame.display.flip()            
